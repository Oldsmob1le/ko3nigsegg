...
class _app {
  ...
  effects = ['i', 'flash', 'pulse', 'rubberBand', 'shake', 'swing', 'tada', 'wobble', 'jello'];
  brandDescription = ['11 years old', 'pro minecraft player', 'ddoser', 'trashtalker', 'Ivan Andreevich fanboy', 'sweet daddy'];
